...
public class AdminAdapter extends Admin {
    ...
    private com.woorinaru.repository.sql.entity.user.Admin adminEntity;
    private EntityManager em;

    public AdminAdapter(com.woorinaru.repository.sql.entity.user.Admin adminEntity, EntityManager em) {

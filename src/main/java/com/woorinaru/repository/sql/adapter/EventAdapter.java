...
import com.woorinaru.core.model.management.administration.WooriClass;
...
public class EventAdapter extends Event {
    ...
    private com.woorinaru.repository.sql.entity.management.administration.Event eventEntity;
    private EntityManager em;

    public EventAdapter(com.woorinaru.repository.sql.entity.management.administration.Event eventEntity, EntityManager em) {
    ...
    public boolean addWooriClass(WooriClass wooriClass) {
        ...
        com.woorinaru.repository.sql.entity.management.administration.WooriClass wooriClassEntity = em.find(com.woorinaru.repository.sql.entity.management.administration.WooriClass.class, wooriClass.getId());

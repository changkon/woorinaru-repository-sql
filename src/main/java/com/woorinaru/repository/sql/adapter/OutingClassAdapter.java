...
public class OutingClassAdapter extends OutingClass {
    ...
    private com.woorinaru.repository.sql.entity.management.administration.OutingClass outingClassEntity;
    private EntityManager em;

    public OutingClassAdapter(com.woorinaru.repository.sql.entity.management.administration.OutingClass outingClassEntity, EntityManager em) {

...
public class ResourceAdapter extends Resource {
    ...
    private com.woorinaru.repository.sql.entity.resource.Resource resourceEntity;

    public ResourceAdapter(com.woorinaru.repository.sql.entity.resource.Resource resourceEntity) {

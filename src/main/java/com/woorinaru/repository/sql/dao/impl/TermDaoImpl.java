...
import com.woorinaru.repository.sql.mapper.model.TermMapper;
...
public class TermDaoImpl implements TermDao {
    ...
    public int create(Term term) {
        ...
        com.woorinaru.repository.sql.entity.management.administration.Term termEntity = mapper.mapToEntity(term);

        // Add staff if present
        if (Objects.nonNull(term.getStaffMembers())) {
            for (com.woorinaru.core.model.user.Staff staffModel : term.getStaffMembers()) {
        ...
        if (Objects.nonNull(term.getEvents())) {
            for (com.woorinaru.core.model.management.administration.Event eventModel : term.getEvents()) {
    ...
    public Term get(int id) {
        ...
        com.woorinaru.repository.sql.entity.management.administration.Term termEntity = em.find(com.woorinaru.repository.sql.entity.management.administration.Term.class, id);
    ...
    public void delete(Term term) {
        ...
        // Map file
        com.woorinaru.repository.sql.entity.management.administration.Term deleteTermEntity = em.find(com.woorinaru.repository.sql.entity.management.administration.Term.class, term.getId());
    ...
    public void modify(Term term) {
        ...
        com.woorinaru.repository.sql.entity.management.administration.Term existingTermEntity = em.find(com.woorinaru.repository.sql.entity.management.administration.Term.class, term.getId());
    ...
    public List<Term> getAll() {
        ...
        TypedQuery<com.woorinaru.repository.sql.entity.management.administration.Term> query = em.createQuery("SELECT t FROM Term t", com.woorinaru.repository.sql.entity.management.administration.Term.class);
        List<com.woorinaru.repository.sql.entity.management.administration.Term> termEntities = query.getResultList();
